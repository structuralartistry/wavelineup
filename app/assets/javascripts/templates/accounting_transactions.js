    ...
    var t = " \
      ...
      <div class='modal-body'> \
        <ul id='accounting_transaction_new_edit'> \
          ...
          <li><a id='accounting_category_id' class='btn option_selector target' data-option_selector_name='accounting_category_<%= income_expense %>' data-set_id='<%= category_id %>' data-set_value=''><%= accounting_category_value %></a></li> \
